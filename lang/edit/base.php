...
echo "
body{margin:0;padding:0;background:url('{$path}image/edit/bg.gif')}
...
.blue_sline{background:url('{$path}image/edit/blue_sline.gif') repeat-x top;height:1px;}
...
.tmpl_btn{width:114px;height:22px;border:0;background:url('{$path}image/edit/tmpl_btn_bg.gif');line-height:22px;}
.smb_btn{width:62px;height:22px;border:0;background:url('{$path}image/edit/smb_btn_bg.gif');line-height:22px;}
.update_btn1{width:98px;height:22px;border:0px;background:url('{$path}image/edit/update_btn1.gif');line-height:22px;}
.update_btn2{width:124px;height:22px;border:0px;background:url('{$path}image/edit/update_btn2.gif');line-height:22px;}
.srch_btn{width:37px;height:22px;border:0;background:url('{$path}image/edit/srch_btn.gif');line-height:18px;}
.vsplit_line{background:url('{$path}image/edit/box_vsplit.gif');}
