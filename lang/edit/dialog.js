function dialog(){
	...
	var src = "";
	var path = "image/face/";
	var sFunc = '<input id="dialogOk" type="button" style="{width:62px;height:22px;border:0;background:url(\'image/edit/smb_btn_bg.gif\');line-height:20px;" value="确认" onclick="new dialog().reset();" /> <input id="dialogCancel" type="button" style="{width:62px;height:22px;border:0;background:url(\'image/edit/smb_btn_bg.gif\');line-height:20px;" value="取消" onclick="new dialog().reset();" />';
