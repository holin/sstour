<?php /* Smarty version 2.6.10, created on 2009-12-13 03:47:14
         compiled from travelyou.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip', 'travelyou.htm', 75, false),array('modifier', 'strip_tags', 'travelyou.htm', 75, false),array('modifier', 'truncate', 'travelyou.htm', 75, false),)), $this); ?>
<HTML>
<HEAD>
...
">路线</a></div>
	  <div id="show">
        <ul class="xspace-listtab">
          <li class="xspace-sublist xspace-active"><a>本社路线</a></li>
          <li class=""><a href="javascript:;" onClick="fshowwindows('<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=member&option=travelyou&type=edit&id=<?php echo $this->_tpl_vars['sql_travel']['sc_id']; ?>
',1,'发布路线');">发布路线</a></li>
        </ul>
        <div>
...
?>
			<li class="xspace-loglist">
              <h4 class="xspace-entrytitle"> <a href="index.php?action=travel&option=travelyouthread&id=<?php echo $this->_tpl_vars['hotelthread']['thr_hid']; ?>
...
)</a> <a href="javascript:;" onClick="_confirm_msg_show('确定删除路线', 'Userloginon(\'<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=update&option=travelyou&type=del&id=<?php echo $this->_tpl_vars['hotelthread']['thr_hid']; ?>
&Industry=<?php echo $this->_tpl_vars['hotelthread']['thr_id']; ?>
\',\'\',\'\',\'location.href=\\\'<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=travel&option=travelyou&id=<?php echo $this->_tpl_vars['hotelthread']['thr_hid']; ?>
\\\'\');', '', '');">删除</a></p>
