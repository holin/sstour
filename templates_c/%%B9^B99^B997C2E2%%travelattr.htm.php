<?php /* Smarty version 2.6.10, created on 2009-12-13 05:51:37
         compiled from travelattr.htm */ ?>
<HTML>
<HEAD>
...
index.php?action=update&option=travelattr&type=edit&id=<?php echo $this->_tpl_vars['sql_hotelthread']['attr_hid']; ?>
&Industry=<?php echo $this->_tpl_vars['sql_hotelthread']['attr_id']; ?>
',1,'修改案例');">修改</a> <a href="javascript:;" onClick="_confirm_msg_show('确定删除案例', 'Userloginon(\'<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=update&option=travelattr&type=del&id=<?php echo $this->_tpl_vars['sql_hotelthread']['attr_hid']; ?>
&Industry=<?php echo $this->_tpl_vars['sql_hotelthread']['attr_id']; ?>
\',\'\',\'\',\'location.href=\\\'<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=travel&option=travelattrs&id=<?php echo $this->_tpl_vars['sql_hotelthread']['attr_hid']; ?>
\\\'\');', '', '');">删除</a></p>
...
index.php?action=word&option=travelattrword','commentform','','');">
            </p>            
          </form>
		  </fieldset>
        </div>
...
');
getNews('showtravelattrword','<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=travel&option=showtravelattrword&id=<?php echo $this->_tpl_vars['sql_travel']['sc_id']; ?>
&Industry=<?php echo $this->_tpl_vars['sql_hotelthread']['attr_id']; ?>
');
</script>
