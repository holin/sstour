<?php /* Smarty version 2.6.10, created on 2010-02-01 00:40:33
         compiled from travelthreadedit.htm */ ?>
<html>
<head>
...
"></td>
			...
			<tr id='article_title'>
              <td>TAG：</td>
              <td><input onFocus="showtextcontent('index.php?action=travel&option=showthreadtage');" type="text" name="blog_tags" class="input_text1" value="<?php echo $this->_tpl_vars['sql_hotelthread']['thr_tages']; ?>
