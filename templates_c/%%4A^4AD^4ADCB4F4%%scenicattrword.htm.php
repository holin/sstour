<?php /* Smarty version 2.6.10, created on 2009-12-21 04:21:36
         compiled from scenicattrword.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip', 'scenicattrword.htm', 5, false),array('modifier', 'strip_tags', 'scenicattrword.htm', 5, false),)), $this); ?>
...
index.php?action=update&option=scenicword&type=postattr&id=<?php echo $this->_tpl_vars['hotelword']['word_hid']; ?>
...
index.php?action=update&option=scenicword&type=delattr&id=<?php echo $this->_tpl_vars['hotelword']['word_hid']; ?>
&Industry=<?php echo $this->_tpl_vars['hotelword']['word_id']; ?>
&Keyword=<?php echo $this->_tpl_vars['hotelword']['word_tid']; ?>
\',\'\',\'getNews(\\\'showscenicattrword\\\',\\\'<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=scenic&option=showscenicattrword&id=<?php echo $this->_tpl_vars['hotelword']['word_hid']; ?>
