<?php /* Smarty version 2.6.10, created on 2010-01-13 00:24:14
         compiled from merchantssingle.htm */ ?>
    ...
    <td width="562" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td class="url">您现在的位置：<a href="index.php">首页</a> &gt; <a href="index.php?action=info&option=merchants">招商引资</a> &gt; <a href="index.php?action=info&option=merchants&id=<?php echo $this->_tpl_vars['sql_info']['new_type']; ?>
