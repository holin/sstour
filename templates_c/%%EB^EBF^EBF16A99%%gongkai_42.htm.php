<?php /* Smarty version 2.6.10, created on 2009-12-14 12:24:54
         compiled from gongkai_42.htm */ ?>
    ...
    <td width="562" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="100%" colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td class="url">您现在的位置：<a href="index.php">首页</a> > 政府信息公开 > <a href="http://www.sstour.net/index.php?action=gongkai&option=42">规划计划</a></td>
              </tr>
            </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td bgcolor="#EBF9FD"><table width="96%" border="0" align="center">
		      <?php $_from = $this->_tpl_vars['sql_42']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
