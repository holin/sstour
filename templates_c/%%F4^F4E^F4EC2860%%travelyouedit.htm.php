<?php /* Smarty version 2.6.10, created on 2010-07-24 08:59:21
         compiled from travelyouedit.htm */ ?>
<html>
<head>
...
"></td>
			...
			<tr id='article_title'>
              <td>TAG：</td>
              <td><input onFocus="showtextcontent('index.php?action=travel&option=showyoutage');" type="text" name="blog_tags" class="input_text1" value="<?php echo $this->_tpl_vars['sql_hotelthread']['thr_tages']; ?>
