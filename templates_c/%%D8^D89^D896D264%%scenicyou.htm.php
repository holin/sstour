<?php /* Smarty version 2.6.10, created on 2009-12-14 14:30:23
         compiled from scenicyou.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip', 'scenicyou.htm', 74, false),array('modifier', 'strip_tags', 'scenicyou.htm', 74, false),array('modifier', 'truncate', 'scenicyou.htm', 74, false),)), $this); ?>
<HTML>
<HEAD>
...
index.php?action=member&option=scenicyou&type=edit&id=<?php echo $this->_tpl_vars['sql_scenic']['sc_id']; ?>
',1,'发布游记');">发布游记</a></li>
        </ul>
        <div>
...
?>
			<li class="xspace-loglist">
              <h4 class="xspace-entrytitle"> <a href="index.php?action=scenic&option=scenicyouthread&id=<?php echo $this->_tpl_vars['hotelthread']['thr_hid']; ?>
...
index.php?action=update&option=scenicyou&type=del&id=<?php echo $this->_tpl_vars['hotelthread']['thr_hid']; ?>
&Industry=<?php echo $this->_tpl_vars['hotelthread']['thr_id']; ?>
\',\'\',\'\',\'location.href=\\\'<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=scenic&option=scenicyou&id=<?php echo $this->_tpl_vars['hotelthread']['thr_hid']; ?>
\\\'\');', '', '');">删除</a></p>
