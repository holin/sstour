<?php /* Smarty version 2.6.10, created on 2009-12-13 03:29:21
         compiled from hotelroom.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip', 'hotelroom.htm', 34, false),array('modifier', 'strip_tags', 'hotelroom.htm', 34, false),)), $this); ?>
<HTML>
<HEAD>
...
">房间</a></div>
      <div id="show">
        <ul class="xspace-listtab">
          <li id="xspace-myentry" class="xspace-sublist xspace-active"><a>房间信息</a></li>
          <li><a href="javascript:;" onClick="fshowwindows('<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=update&option=hotelroom&type=edit&id=<?php echo $this->_tpl_vars['sql_hotel']['hot_id']; ?>
',1,'添加房间');">添加房间</a></li>
        </ul>
...
?>
          <li class="xspace-coverlist">
            <h4 class="xspace-entrytitle"><strong class="xspace-imgstyle"><?php if ($this->_tpl_vars['hotelroom']['room_image'] != ''): ?><img src="<?php echo $this->_tpl_vars['hotelroom']['room_image']; ?>
" class="xspace-imgcover" alt="<?php echo $this->_tpl_vars['hotelroom']['room_subject']; ?>
" /><?php else: ?><img src="image/lvyou/questionmark.gif" class="xspace-imgcover" alt="<?php echo $this->_tpl_vars['hotelroom']['room_subject']; ?>
" /><?php endif; ?></strong> <?php echo $this->_tpl_vars['hotelroom']['room_subject']; ?>
(价格：<?php echo $this->_tpl_vars['hotelroom']['room_price']; ?>
)</h4>
			<p class="xspace-smalltxt"> <?php echo $this->_tpl_vars['hotelroom']['room_date']; ?>
 <span class="xspace-smalltxt"><?php echo $this->_tpl_vars['hotelroom']['room_tages']; ?>
</span></p>
			<p class="xspace-smalltxt"> <?php echo $this->_tpl_vars['hotelroom']['room_info']; ?>
</p>
            <p class="xspace-itemlinks"> <?php if ($this->_tpl_vars['hotelroom']['room_pass'] == '1'): ?><a href="javascript:;" onClick="Userloginon('<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=update&option=hotelroom&type=delpass&id=<?php echo $this->_tpl_vars['hotelroom']['room_hid']; ?>
&Industry=<?php echo $this->_tpl_vars['hotelroom']['room_id']; ?>
','','','');">取消推荐</a><?php else: ?><a href="javascript:;" onClick="Userloginon('<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=update&option=hotelroom&type=pass&id=<?php echo $this->_tpl_vars['hotelroom']['room_hid']; ?>
&Industry=<?php echo $this->_tpl_vars['hotelroom']['room_id']; ?>
','','','');">推荐</a><?php endif; ?> <a href="javascript:;" onClick="fshowwindows('<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=update&option=hotelroom&type=edit&id=<?php echo $this->_tpl_vars['hotelroom']['room_hid']; ?>
&Industry=<?php echo $this->_tpl_vars['hotelroom']['room_id']; ?>
',1,'修改房间');">修改</a> <a href="javascript:;" onClick="_confirm_msg_show('确定删除房间', 'Userloginon(\'<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=update&option=hotelroom&type=del&id=<?php echo $this->_tpl_vars['hotelroom']['room_hid']; ?>
&Industry=<?php echo $this->_tpl_vars['hotelroom']['room_id']; ?>
\',\'\',\'\',\'\');', '', '');">删除</a></p>
          </li>
