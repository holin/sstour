<?php /* Smarty version 2.6.10, created on 2009-12-13 07:25:19
         compiled from scenicyouthread.htm */ ?>
<HTML>
<HEAD>
...
)</a> <a href="javascript:;" onClick="_confirm_msg_show('确定删除游记', 'Userloginon(\'<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=update&option=scenicyou&type=del&id=<?php echo $this->_tpl_vars['sql_hotelthread']['thr_hid']; ?>
&Industry=<?php echo $this->_tpl_vars['sql_hotelthread']['thr_id']; ?>
\',\'\',\'\',\'location.href=\\\'<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=scenic&option=scenicyou&id=<?php echo $this->_tpl_vars['sql_hotelthread']['thr_hid']; ?>
\\\'\');', '', '');">删除</a></p>
...
index.php?action=word&option=scenicyouword','commentform','','');">
            </p>            
          </form>
		  </fieldset>
        </div>
...
index.php?action=scenic&option=showyouword&id=<?php echo $this->_tpl_vars['sql_scenic']['sc_id']; ?>
&Industry=<?php echo $this->_tpl_vars['sql_hotelthread']['thr_id']; ?>
');
</script>
