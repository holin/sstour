<?php /* Smarty version 2.6.10, created on 2009-12-13 06:58:59
         compiled from scenicphoto.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'truncate', 'scenicphoto.htm', 103, false),)), $this); ?>
<HTML>
<HEAD>
...
index.php?action=update&option=scenicphoto&id=<?php echo $this->_tpl_vars['sql_scenic']['sc_id']; ?>
";
}
...
index.php?action=update&option=scenicphoto&id=<?php echo $this->_tpl_vars['sql_hotelimage']['hi_hid']; ?>
...
','<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=update&option=scenicphoto&id=<?php echo $this->_tpl_vars['hotelimage']['hi_hid']; ?>
