<?php /* Smarty version 2.6.10, created on 2010-07-07 08:36:40
         compiled from scenicattredit.htm */ ?>
<html>
<head>
...
" enctype="multipart/form-data" method="post" target="iframe_data">
          ...
          <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
            <tr id='article_title'>
              <td>文章标题：</td>
              <td><input type="text" name="blog_title" id="blog_title" class="input_text1" style="width:450px" maxlength="72"  value="<?php echo $this->_tpl_vars['sql_hotelthread']['attr_subject']; ?>
"></td>
            </tr>
			<tr id='article_title'>
              <td>门票：</td>
              <td><input type="text" name="blog_price" class="input_text1" value="<?php echo $this->_tpl_vars['sql_hotelthread']['attr_price']; ?>
" style="width:150px;" /></td>
            </tr>
			<tr id='article_title'>
              <td>TAG：</td>
              <td><input onFocus="showtextcontent('index.php?action=scenic&option=showattrtag');" type="text" name="blog_tags" class="input_text1" value="<?php echo $this->_tpl_vars['sql_hotelthread']['attr_tages']; ?>
" style="width:150px;" /></td>
            </tr>
            <!-- 编辑器 -->
            <tr>
