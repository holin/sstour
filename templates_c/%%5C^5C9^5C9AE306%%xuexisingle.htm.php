<?php /* Smarty version 2.6.10, created on 2009-12-13 03:02:03
         compiled from xuexisingle.htm */ ?>
    ...
    <td width="562" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td class="url">您现在的位置：<a href="index.php">首页</a> &gt; <a href="index.php?action=info&option=xuexi">深入学习实践科学发展观</a> &gt; <a href="index.php?action=info&option=xuexi&id=<?php echo $this->_tpl_vars['sql_info']['new_type']; ?>
