<?php /* Smarty version 2.6.10, created on 2009-12-13 03:15:40
         compiled from hotelphoto.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip', 'hotelphoto.htm', 78, false),array('modifier', 'strip_tags', 'hotelphoto.htm', 78, false),array('modifier', 'truncate', 'hotelphoto.htm', 105, false),)), $this); ?>
<HTML>
<HEAD>
...
index.php?action=update&option=hotelphoto&id=<?php echo $this->_tpl_vars['sql_hotel']['hot_id']; ?>
";
}
...
index.php?action=update&option=hotelphoto&id=<?php echo $this->_tpl_vars['sql_hotelimage']['hi_hid']; ?>
...
' alt='<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['sql_hotelimage']['hi_subject'])) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)))) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)); ?>
' /><BR />
      <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['sql_hotelimage']['hi_subject'])) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)))) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)); ?>
</a></div>
  </div>
  <?php else: ?>
...
','<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=update&option=hotelphoto&id=<?php echo $this->_tpl_vars['hotelimage']['hi_hid']; ?>
...
' alt='<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['hotelimage']['hi_subject'])) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)))) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)); ?>
' /><BR />
      <?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['hotelimage']['hi_subject'])) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)))) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 10, "", true) : smarty_modifier_truncate($_tmp, 10, "", true)); ?>
</a></div>
