<?php /* Smarty version 2.6.10, created on 2010-01-14 00:52:24
         compiled from hotelthreadword.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip', 'hotelthreadword.htm', 5, false),array('modifier', 'strip_tags', 'hotelthreadword.htm', 5, false),)), $this); ?>
...
index.php?action=update&option=hotelword&type=postthread&id=<?php echo $this->_tpl_vars['hotelword']['word_hid']; ?>
...
index.php?action=update&option=hotelword&type=delthread&id=<?php echo $this->_tpl_vars['hotelword']['word_hid']; ?>
&Industry=<?php echo $this->_tpl_vars['hotelword']['word_id']; ?>
&Keyword=<?php echo $this->_tpl_vars['hotelword']['word_tid']; ?>
\',\'\',\'getNews(\\\'showthreadword\\\',\\\'<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=hotel&option=showthreadword&id=<?php echo $this->_tpl_vars['hotelword']['word_hid']; ?>
