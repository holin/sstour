<?php /* Smarty version 2.6.10, created on 2010-02-01 21:14:43
         compiled from travelattredit.htm */ ?>
<html>
<head>
...
"></td>
			...
			<tr id='article_title'>
              <td>TAG：</td>
              <td><input onFocus="showtextcontent('index.php?action=travel&option=showattrtag');" type="text" name="blog_tags" class="input_text1" value="<?php echo $this->_tpl_vars['sql_hotelthread']['attr_tages']; ?>
