    ...
    <td width="562" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td class="url">您现在的位置：<a href="index.php">首页</a> &gt; <a href="index.php?action=news&id=<?php echo $this->_tpl_vars['sql_info']['type_id']; ?>
"><?php echo $this->_tpl_vars['sql_info']['type_subject']; ?>
        ...
        <tr>
          <td colspan="3" bgcolor="#EBF9FD"><table width="94%" border="0" align="center" cellpadding="0" cellspacing="4">
			  ...
			  <?php if ($this->_tpl_vars['sql_info']['new_writer'] != ''): ?><tr><td>作者：<?php echo $this->_tpl_vars['sql_info']['new_writer']; ?>
</td></tr><?php endif; ?>
			  <?php if ($this->_tpl_vars['sql_info']['new_quote'] != ''): ?><tr><td>引用：<?php echo $this->_tpl_vars['sql_info']['new_quote']; ?>
</td></tr><?php endif; ?>
              <tr>
