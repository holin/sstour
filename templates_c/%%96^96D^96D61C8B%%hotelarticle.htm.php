<?php /* Smarty version 2.6.10, created on 2009-12-13 00:58:17
         compiled from hotelarticle.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip', 'hotelarticle.htm', 34, false),array('modifier', 'strip_tags', 'hotelarticle.htm', 34, false),array('modifier', 'truncate', 'hotelarticle.htm', 76, false),)), $this); ?>
<HTML>
<HEAD>
...
">资讯</a></div>
      <div id="show">
        <ul class="xspace-listtab">
          <li class="xspace-sublist xspace-active"><a>酒店资讯</a></li>
          <li class=""><a href="javascript:;" onClick="fshowwindows('<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=update&option=hotelarticle&type=edit&id=<?php echo $this->_tpl_vars['sql_hotel']['hot_id']; ?>
',1,'发布资讯');">发布资讯</a></li>
        </ul>
        <div>
...
?>
			<li class="xspace-loglist">
              <h4 class="xspace-entrytitle"> <a href="index.php?action=hotel&option=hotelthread&id=<?php echo $this->_tpl_vars['hotelthread']['thr_hid']; ?>
...
index.php?action=update&option=hotelarticle&type=edit&id=<?php echo $this->_tpl_vars['hotelthread']['thr_hid']; ?>
&Industry=<?php echo $this->_tpl_vars['hotelthread']['thr_id']; ?>
',1,'修改资讯');">修改</a> <a href="javascript:;" onClick="_confirm_msg_show('确定删除资讯', 'Userloginon(\'<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=update&option=hotelarticle&type=del&id=<?php echo $this->_tpl_vars['hotelthread']['thr_hid']; ?>
&Industry=<?php echo $this->_tpl_vars['hotelthread']['thr_id']; ?>
\',\'\',\'\',\'location.href=\\\'<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=hotel&option=hotelarticle&id=<?php echo $this->_tpl_vars['hotelthread']['thr_hid']; ?>
\\\'\');', '', '');">删除</a></p>
