<?php /* Smarty version 2.6.10, created on 2010-08-24 15:03:05
         compiled from scenicseach.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip', 'scenicseach.htm', 32, false),array('modifier', 'strip_tags', 'scenicseach.htm', 32, false),array('modifier', 'date_format', 'scenicseach.htm', 33, false),)), $this); ?>
    ...
    <td width="562" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td class="url">您现在的位置：<a href="index.php">首页</a> &gt; <a href="index.php?action=info&id=7">游记</a></td>
              </tr>
            </table></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td width="93%"  class="title_green">景区游记</td>
        </tr>
        <tr>
...
?>
              ...
              <tr class="line_bg3">
                <td width="84%"><img src="image/lvyou/ico_new.gif" width="9" height="9"> <a target="_blank" href="index.php?action=scenic&option=scenicyouthread&id=<?php echo $this->_tpl_vars['hotelyou']['thr_hid']; ?>
...
"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['hotelyou']['thr_subject'])) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)))) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)); ?>
                ...
                <td width="16%" class="txt_day"><?php echo ((is_array($_tmp=$this->_tpl_vars['hotelyou']['thr_date'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y-%m-%d") : smarty_modifier_date_format($_tmp, "%Y-%m-%d")); ?>
</td>
              </tr>
