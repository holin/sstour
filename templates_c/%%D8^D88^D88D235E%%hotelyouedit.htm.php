<?php /* Smarty version 2.6.10, created on 2010-02-24 22:37:24
         compiled from hotelyouedit.htm */ ?>
<html>
<head>
...
"></td>
			...
			<tr id='article_title'>
              <td>TAG：</td>
              <td><input onFocus="showtextcontent('index.php?action=hotel&option=showyoutage');" type="text" name="blog_tags" class="input_text1" value="<?php echo $this->_tpl_vars['sql_hotelthread']['thr_tages']; ?>
