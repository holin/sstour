<?php /* Smarty version 2.6.10, created on 2009-12-13 19:45:22
         compiled from scenicword.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip', 'scenicword.htm', 68, false),array('modifier', 'strip_tags', 'scenicword.htm', 68, false),)), $this); ?>
<HTML>
<HEAD>
...
index.php?action=update&option=scenicword&type=post&id=<?php echo $this->_tpl_vars['hotelword']['word_hid']; ?>
...
index.php?action=update&option=scenicword&type=del&id=<?php echo $this->_tpl_vars['hotelword']['word_hid']; ?>
&Industry=<?php echo $this->_tpl_vars['hotelword']['word_id']; ?>
...
&nbsp;&nbsp; IP: <?php echo $this->_tpl_vars['hotelword']['word_ip']; ?>
		...
		<fieldset>
          <form id="commentform" name="commentform" method="post">            
            <legend>给 <?php echo $this->_tpl_vars['sql_scenic']['sc_subject']; ?>
 留言</legend>
            <p>
...
index.php?action=word&option=scenicword','commentform','','');">
            </p>            
          </form>
		  </fieldset>
        </div>
