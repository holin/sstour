<?php /* Smarty version 2.6.10, created on 2009-12-27 01:30:20
         compiled from merchants.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'merchants.htm', 32, false),)), $this); ?>
    ...
    <td width="562" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td class="url">您现在的位置：<a href="index.php">首页</a> &gt; <a href="index.php?action=info&option=merchants">招商引资</a></td>
              </tr>
            </table></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td width="93%"  class="title_green"><?php if ($this->_tpl_vars['id'] != ''):  echo $this->_tpl_vars['sql_class']['type_subject'];  else: ?>招商引资<?php endif; ?></td>
        </tr>
        <tr>
...
?>
              <tr class="line_bg3">
                <td width="84%"><img src="image/lvyou/ico_new.gif" width="9" height="9"> <a href="index.php?action=info&option=merchantssingle&id=<?php echo $this->_tpl_vars['info']['new_id']; ?>
