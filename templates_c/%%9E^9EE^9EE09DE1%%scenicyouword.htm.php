<?php /* Smarty version 2.6.10, created on 2009-12-13 23:06:11
         compiled from scenicyouword.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip', 'scenicyouword.htm', 5, false),array('modifier', 'strip_tags', 'scenicyouword.htm', 5, false),)), $this); ?>
...
index.php?action=update&option=scenicword&type=postyou&id=<?php echo $this->_tpl_vars['hotelword']['word_hid']; ?>
...
index.php?action=update&option=scenicword&type=delyou&id=<?php echo $this->_tpl_vars['hotelword']['word_hid']; ?>
&Industry=<?php echo $this->_tpl_vars['hotelword']['word_id']; ?>
&Keyword=<?php echo $this->_tpl_vars['hotelword']['word_tid']; ?>
\',\'\',\'getNews(\\\'showthreadword\\\',\\\'<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=scenic&option=showyouword&id=<?php echo $this->_tpl_vars['hotelword']['word_hid']; ?>
