<?php /* Smarty version 2.6.10, created on 2009-12-13 07:36:05
         compiled from gongkai_36.htm */ ?>
    ...
    <td width="562" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td class="url">您现在的位置：<a href="index.php">首页</a> > <a href="http://www.sstour.net/index.php?action=gongkai">法律法规</a></td>
              </tr>
            </table></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td width="93%"  class="title_green">1.国务院行政法规及规范性文件</td>
        </tr>
        <tr>
          <td colspan="2" bgcolor="#EBF9FD"><table width="96%" border="0" align="center">
		      <?php $_from = $this->_tpl_vars['sql_37']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
"><?php echo $this->_tpl_vars['info']['new_subject']; ?>
        ...
        <tr>
          ...
          <td  class="title_green">2.地方性法规</td>
        </tr>
        <tr>
          <td colspan="2" bgcolor="#EBF9FD"><table width="96%" border="0" align="center">
  <?php $_from = $this->_tpl_vars['sql_38']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['info']):
?>
  <tr class="line_bg3">
    <td><img src="image/lvyou/ico_new.gif" width="9" height="9" /> <a href="http://www.sstour.net/index.php?action=info&amp;option=single&amp;id=<?php echo $this->_tpl_vars['info']['new_id']; ?>
"><?php echo $this->_tpl_vars['info']['new_subject']; ?>
  ...
  <?php endforeach; endif; unset($_from); ?>
        ...
        <tr>
          <td  class="title_green"><img src="image/lvyou/icon_7.gif" width="35" height="24" /></td>
          <td  class="title_green">3.地方政府规章及规范性文件</td>
        </tr>
        <tr>
          <td colspan="2" bgcolor="#EBF9FD"><table width="96%" border="0" align="center">
  <?php $_from = $this->_tpl_vars['sql_39']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['info']):
?>
  <tr class="line_bg3">
    <td><img src="image/lvyou/ico_new.gif" width="9" height="9" /> <a href="http://www.sstour.net/index.php?action=info&amp;option=single&amp;id=<?php echo $this->_tpl_vars['info']['new_id']; ?>
"><?php echo $this->_tpl_vars['info']['new_subject']; ?>
  ...
  <?php endforeach; endif; unset($_from); ?>
        ...
        <tr>
          <td  class="title_green"><img src="image/lvyou/icon_7.gif" width="35" height="24" /></td>
          <td  class="title_green">4.国家旅游局规章及规范性文件</td>
        </tr>
        <tr>
          <td colspan="2" bgcolor="#EBF9FD"><table width="96%" border="0" align="center">
  <?php $_from = $this->_tpl_vars['sql_40']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['info']):
?>
  <tr class="line_bg3">
    <td><img src="image/lvyou/ico_new.gif" width="9" height="9" /> <a href="http://www.sstour.net/index.php?action=info&amp;option=single&amp;id=<?php echo $this->_tpl_vars['info']['new_id']; ?>
"><?php echo $this->_tpl_vars['info']['new_subject']; ?>
  ...
  <?php endforeach; endif; unset($_from); ?>
        ...
        <tr>
          <td  class="title_green"><img src="image/lvyou/icon_7.gif" width="35" height="24" /></td>
          <td  class="title_green">5.旅游标准</td>
        </tr>
        <tr>
          <td colspan="2" bgcolor="#EBF9FD"><table width="96%" border="0" align="center">
  <?php $_from = $this->_tpl_vars['sql_41']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['info']):
?>
  <tr class="line_bg3">
    <td><img src="image/lvyou/ico_new.gif" width="9" height="9" /> <a href="http://www.sstour.net/index.php?action=info&amp;option=single&amp;id=<?php echo $this->_tpl_vars['info']['new_id']; ?>
