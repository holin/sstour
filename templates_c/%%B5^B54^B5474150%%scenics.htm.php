<?php /* Smarty version 2.6.10, created on 2009-12-15 00:06:01
         compiled from scenics.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip', 'scenics.htm', 40, false),array('modifier', 'strip_tags', 'scenics.htm', 40, false),array('modifier', 'truncate', 'scenics.htm', 43, false),)), $this); ?>
    ...
    <td width="562" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td class="url">您现在的位置：<a href="index.php">首页</a> &gt; <a href="index.php?action=scenic">景区</a></td>
              </tr>
            </table></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td width="93%"  class="title_green">景区</td>
        </tr>
        <tr>
          <td colspan="2" bgcolor="#EBF9FD"><table width="96%" border="0" align="center">
              <?php $_from = $this->_tpl_vars['sql_scenic']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
                ...
                <td bgcolor="#EBF9FD"><table width="100%" border="0" cellspacing="4">
                    <tr>
                      <td width="27%" valign="top"><table border="0">
                          <tr>
                            <td class="border_pic"><?php if ($this->_tpl_vars['scenic']['sc_logo'] != ''): ?><a href="index.php?action=scenic&option=single&id=<?php echo $this->_tpl_vars['scenic']['sc_id']; ?>
"><img src="<?php echo $this->_tpl_vars['scenic']['sc_logo']; ?>
" width="137" height="100"></a><?php else: ?><a href="index.php?action=scenic&option=single&id=<?php echo $this->_tpl_vars['scenic']['sc_id']; ?>
"><img src="image/lvyou/jingqu_22.gif" width="137" height="100"></a><?php endif; ?></td>
                          </tr>
                        </table></td>
                      <td width="73%" valign="top"><table width="100%" border="0">
                          <tr>
                            <td class="txt_green"><a href="index.php?action=scenic&option=single&id=<?php echo $this->_tpl_vars['scenic']['sc_id']; ?>
"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['scenic']['sc_subject'])) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)))) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)); ?>
</a></td>
                          </tr>
                          <tr>
                            <td><?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['scenic']['sc_info'])) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)))) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 200, "...", true) : smarty_modifier_truncate($_tmp, 200, "...", true)); ?>
</td>
                          </tr>
                          <tr>
                            <td align="right" ><a href="index.php?action=scenic&option=single&id=<?php echo $this->_tpl_vars['scenic']['sc_id']; ?>
