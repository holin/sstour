<?php /* Smarty version 2.6.10, created on 2009-12-13 01:00:15
         compiled from scenicattrs.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip', 'scenicattrs.htm', 34, false),array('modifier', 'strip_tags', 'scenicattrs.htm', 34, false),array('modifier', 'truncate', 'scenicattrs.htm', 74, false),)), $this); ?>
<HTML>
<HEAD>
...
">景点</a></div>
	  <div id="show">
        <ul class="xspace-listtab">
          <li class="xspace-sublist xspace-active"><a>景点资讯</a></li>
          <li class=""><a href="javascript:;" onClick="fshowwindows('<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=update&option=scenicattr&type=edit&id=<?php echo $this->_tpl_vars['sql_scenic']['sc_id']; ?>
',1,'发布资讯');">添加景点</a></li>
        </ul>
        <div>
          <ul class="xspace-itemlist">
            <?php $_from = $this->_tpl_vars['sql_scenicattr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['scenicattr']):
?>
			<li class="xspace-loglist">
              <h4 class="xspace-entrytitle"> <a href="index.php?action=scenic&option=scenicattr&id=<?php echo $this->_tpl_vars['scenicattr']['attr_hid']; ?>
&Industry=<?php echo $this->_tpl_vars['scenicattr']['attr_id']; ?>
"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['scenicattr']['attr_subject'])) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)))) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)); ?>
</a></h4>
              <p class="xspace-smalltxt"> <?php echo $this->_tpl_vars['scenicattr']['attr_date']; ?>
 (门票:<?php echo $this->_tpl_vars['scenicattr']['attr_price']; ?>
) <a href="javascript:;" onClick="fshowwindows('<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=update&option=scenicattr&type=edit&id=<?php echo $this->_tpl_vars['scenicattr']['attr_hid']; ?>
&Industry=<?php echo $this->_tpl_vars['scenicattr']['attr_id']; ?>
',1,'修改门票');">修改</a> <a href="javascript:;" onClick="_confirm_msg_show('确定删除门票', 'Userloginon(\'<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=update&option=scenicattr&type=del&id=<?php echo $this->_tpl_vars['scenicattr']['attr_hid']; ?>
&Industry=<?php echo $this->_tpl_vars['scenicattr']['attr_id']; ?>
\',\'\',\'\',\'location.href=\\\'<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=scenic&option=scenicattrs&id=<?php echo $this->_tpl_vars['scenicattr']['attr_hid']; ?>
\\\'\');', '', '');">删除</a></p>
              <div class="xspace-itemmessage" id="xspace-item169"> <?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['scenicattr']['attr_content'])) ? $this->_run_mod_handler('strip', true, $_tmp) : smarty_modifier_strip($_tmp)))) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 300, "", true) : smarty_modifier_truncate($_tmp, 300, "", true)); ?>
</div>
            </li>
