<?php /* Smarty version 2.6.10, created on 2009-12-13 08:42:36
         compiled from travelthread.htm */ ?>
<HTML>
<HEAD>
...
index.php?action=update&option=travelarticle&type=edit&id=<?php echo $this->_tpl_vars['sql_hotelthread']['thr_hid']; ?>
...
index.php?action=update&option=travelarticle&type=del&id=<?php echo $this->_tpl_vars['sql_hotelthread']['thr_hid']; ?>
&Industry=<?php echo $this->_tpl_vars['sql_hotelthread']['thr_id']; ?>
\',\'\',\'\',\'location.href=\\\'<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=hotel&option=travelarticle&id=<?php echo $this->_tpl_vars['sql_hotelthread']['thr_hid']; ?>
\\\'\');', '', '');">删除</a></p>
...
index.php?action=word&option=travelthreadword','commentform','','');">
            </p>            
          </form>
		  </fieldset>
        </div>
...
index.php?action=travel&option=showthreadword&id=<?php echo $this->_tpl_vars['sql_travel']['sc_id']; ?>
&Industry=<?php echo $this->_tpl_vars['sql_hotelthread']['thr_id']; ?>
');
</script>
