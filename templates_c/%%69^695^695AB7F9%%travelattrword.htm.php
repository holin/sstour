<?php /* Smarty version 2.6.10, created on 2009-12-14 06:48:49
         compiled from travelattrword.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip', 'travelattrword.htm', 5, false),array('modifier', 'strip_tags', 'travelattrword.htm', 5, false),)), $this); ?>
...
index.php?action=update&option=travelword&type=postattr&id=<?php echo $this->_tpl_vars['hotelword']['word_hid']; ?>
...
index.php?action=update&option=travelword&type=delattr&id=<?php echo $this->_tpl_vars['hotelword']['word_hid']; ?>
&Industry=<?php echo $this->_tpl_vars['hotelword']['word_id']; ?>
&Keyword=<?php echo $this->_tpl_vars['hotelword']['word_tid']; ?>
\',\'\',\'getNews(\\\'showtravelattrword\\\',\\\'<?php echo $this->_tpl_vars['boardurl']; ?>
index.php?action=travel&option=showtravelattrword&id=<?php echo $this->_tpl_vars['hotelword']['word_hid']; ?>
