...
?>
    <?php if ($this->_tpl_vars['file'] == 'admin'): ?>
    <tr>
      <td class=b>系统后台</td>
      <td class=b><?php echo $this->_tpl_vars['file']; ?>
</td>
      <td class=b><a href="javascript:getNews('showtable','admin.php?action=<?php echo $this->_tpl_vars['action']; ?>
&option=file&id=<?php echo $this->_tpl_vars['file']; ?>
');">查看</a>
        <input type=hidden name="action[<?php echo $this->_tpl_vars['file']; ?>
]" value='<?php echo $this->_tpl_vars['file']; ?>
'></td>
    </tr>
    <?php elseif ($this->_tpl_vars['file'] == $this->_tpl_vars['configdir']): ?>
    <tr>
      <td class=b><input type="checkbox" name="file[<?php echo $this->_tpl_vars['file']; ?>
...
<?php elseif ($this->_tpl_vars['option'] == 'file'): ?>
<table width=98% align=center cellspacing=1 cellpadding=3 class=i_table>
  <tr>
    <td colspan="3" class=head> 模 板 目 录</td>
  </tr>
  <tr>
    <td colspan="3" align="right" class=b><a title='返回' href='javascript:;' onclick="fshowwindowsclos('showwindow');getNews('showtable','admin.php?action=template')">返回</a></td>
  </tr>
  <?php echo $this->_tpl_vars['mofile']; ?>
...
function article_preview()
{
	if (check_article_form()){
		...
		et.save();
		$('article').submit();
		$('article').action = "<?php echo $this->_tpl_vars['boardurl']; ?>
admin.php?<?php echo $this->_tpl_vars['userop']; ?>
";
...
function initForm(_sId){
	var sFileUpload = '\
<form id="form' + _sId + '" title="" enctype="multipart/form-data" action="<?php echo $this->_tpl_vars['boardurl']; ?>
