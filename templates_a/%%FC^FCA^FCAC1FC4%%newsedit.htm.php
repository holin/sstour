<?php /* Smarty version 2.6.10, created on 2010-01-07 17:49:02
         compiled from newsedit.htm */ ?>
<html>
<head>
...
function article_preview()
{
	if (check_article_form()){
		...
		et.save();
		$('article').submit();
		$('article').action = "admin.php?action=<?php echo $this->_tpl_vars['action']; ?>
...
function initForm(_sId){
	var sFileUpload = '\
<form id="form' + _sId + '" title="" enctype="multipart/form-data" action="admin.php?action=<?php echo $this->_tpl_vars['action']; ?>
&option=<?php echo $this->_tpl_vars['option']; ?>
...
<body>
<form id="sortForm" name="sortForm" method="post" action="admin.php?action=<?php echo $this->_tpl_vars['action']; ?>
&option=<?php echo $this->_tpl_vars['option']; ?>
" target="iframe_data">
  <input type="hidden" id="update" name="update" value="addtype">
...
<div align="center">
  <table border="0" cellspacing="0" cellpadding="0" style="border:1px solid #505050;">
    ...
    <tr>
      <td><form id="article" name="article" action="admin.php?action=<?php echo $this->_tpl_vars['action']; ?>
&option=<?php echo $this->_tpl_vars['option']; ?>
" enctype="multipart/form-data" method="post" target="iframe_data">
          <input id="bid" name="bid" type="hidden" value="<?php echo $this->_tpl_vars['sql_news']['new_id']; ?>
">
          ...
          <input id="ttype" name="ttype" type="hidden" value="2">
          <table width="100%"  border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
            <tr id='article_title'>
              <td>文章标题：</td>
              <td><input type="text" name="blog_title" id="blog_title" class="input_text1" style="width:450px" maxlength="72"  value="<?php echo $this->_tpl_vars['sql_news']['new_subject']; ?>
">
                <a href="javascript:;"><img src="image/edit/publish_calendar.gif" width="16" height="18" align="absmiddle" border="0" onClick="add_calendar('<?php echo $this->_tpl_vars['nowtitle']; ?>
');" title="当前日期"></a></td>
            </tr>
			<tr>
              <td>文章作者：</td>
              <td><input type="text" name="blog_writer" id="blog_writer" class="input_text1" style="width:450px" maxlength="72"  value="<?php echo $this->_tpl_vars['sql_news']['new_writer']; ?>
"></td>
            </tr>
			<tr>
              <td>文章引用：</td>
              <td><input type="text" name="blog_quote" id="blog_quote" class="input_text1" style="width:450px" maxlength="72"  value="<?php echo $this->_tpl_vars['sql_news']['new_quote']; ?>
"></td>
            </tr>
			<tr>
              <td>代表图片：</td>
              <td><input type="text" name="blog_image" id="blog_image" class="input_text1" style="width:450px" maxlength="72"  value="<?php echo $this->_tpl_vars['sql_news']['new_image']; ?>
"></td>
            </tr>
			<tr>
              <td></td>
              <td>(可以上传后查看代码获得想要的图片地址)</td>
            </tr>
            <tr>
              <td>文章类别：</td>
              <td><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="10"><select id="blog_class" name="blog_class" style='width:200px;height:20px'>
                        <?php echo $this->_tpl_vars['showoption']; ?>

                      </select>
                    </td>
                    <td><table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td id="add_sort_txt" style="display:none;background:#99afc2"><input type="text" id="sort_txt" name="sort_txt" maxlength="24" style="width:80px;height:18px" class="input_text1" title="请在此处填写分类"></td>
                          <td id="add_sort_desc" style="display:none;background:#99afc2"><a href="javascript:check_sort_form()" title="增加分类"><img src="image/edit/publish_add_sort_title.gif" align="absmiddle" border="0"></a></td>
                          <td class="sort_open" id="add_sort_switch" onClick="add_sort_switch()" title="开启关闭'增加分类输入框'"><img src="image/edit/null.gif" border="0" width="17"> </td>
                        </tr>
                      </table></td>
                  </tr>
                </table></td>
  ...
  <table border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr>
      <td align="center"><input name="prview" onClick="article_preview();" value=" 预 览 " type="button" class="update_btn1">
        &nbsp;&nbsp;
        <input name="publish" onClick="publish_article();" value=" 保 存 修 改 " type="submit" class="update_btn1">
      </td>
    <tr>
  </table>
</div>
